...
class MainWindow(ctk.CTk):
    ...
    def _setup_ui(self) -> None:
        ...
        # Frame de información de la canción actual
        self._info_frame = ctk.CTkFrame(main_frame, fg_color="transparent")
        ...
        self._playlist_view.pack(fill="both", expand=True, padx=20, pady=(10, 20))
    ...
    def _on_position_update(self, position: float, duration: float) -> None:
        """
        Callback para actualizaciones de posición
